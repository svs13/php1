...
<head>
    ...
    <title>Изображение во весь экран</title>
    <style>
        nav, footer {
...
<header>
    <h3 style="text-align: center">Изображение во весь экран</h3>
</header>
...
<section style="min-height: 70vh">
    ...
    <a href="/homework9/gallery.php">
        <img src="/homework9/images/<?php echo $image; ?>" width="100%">
    </a>
